...
import { fetchData, setLimit, setPage, setSearch } from '../../../../../store/slices/lists/toolingListSlice';
...
const ToolingSearch = React.memo(({ props, id, selectedValue, options, onChange, access }) => {
  ...
  const handleChange = (event, newValue) => {
    ...
    if (onOptionSelect) {
      onOptionSelect('toolingCode', newValue);
    }
  };
  //
  return (
