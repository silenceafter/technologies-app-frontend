...
export const fetchData = createAsyncThunk(
  ...
  async ({ search, limit, page }, { rejectWithValue }) => {
    try {
      ...
      const response = await fetch(`${baseUrl}/ivc/ogt/executescripts/getEquipment.v0.php?search=${search}&&limit=${limit}&page=${page}`); /* http://localhost/ivc/ogt/executescripts/getEquipment.v0.php?search=${search}&&limit=${limit}&page=${page} */
